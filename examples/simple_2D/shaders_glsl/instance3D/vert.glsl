...
layout(location = 1) lowp in vec2 texcoord;
layout(location = 2) lowp in vec4 color;
...
layout(location = 6) lowp in vec4 instance_color;
layout(location = 7) lowp in uint instance_texture;
layout(location = 8) lowp in vec2 instance_texcoord_offset;

layout(location = 0) lowp out vec4 v_color;
layout(location = 1) lowp out vec2 v_texcoord;
layout(location = 2) lowp out uint v_nbtexture;
