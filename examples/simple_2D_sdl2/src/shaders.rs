...
use HGE::Shaders::Manager::{ShaderContent, Shader_type};
use HGE::Shaders::{names, Manager};

pub mod HGE_rawshader_3Dinstance_vertex
{
	vulkano_shaders::shader! {
		ty: "vertex",
		path: "./shaders_glsl/instance3D/vert.glsl"
	}
}
...
pub mod HGE_rawshader_3Dinstance_frag
{
	vulkano_shaders::shader! {
		ty: "fragment",
		path: "./shaders_glsl/instance3D/frag.glsl"
	}
}
...
pub mod HGE_rawshader_screen_vert
{
	vulkano_shaders::shader! {
		ty: "vertex",
		path: "./shaders_glsl/screen/vert.glsl"
	}
}
...
pub mod HGE_rawshader_screen_frag
{
	vulkano_shaders::shader! {
		ty: "fragment",
		path: "./shaders_glsl/screen/frag.glsl"
	}
}
...
pub mod HGE_rawshader_2Dsimple_vert
{
	vulkano_shaders::shader! {
		ty: "vertex",
		path: "./shaders_glsl/simple2D/vert.glsl",
	}
}
...
pub mod HGE_rawshader_2Dsimple_frag
{
	vulkano_shaders::shader! {
		ty: "fragment",
		path: "./shaders_glsl/simple2D/frag.glsl"
	}
}
...
pub mod HGE_rawshader_3Dsimple_vert
{
	vulkano_shaders::shader! {
		ty: "vertex",
		path: "./shaders_glsl/simple3D/vert.glsl",
	}
}
...
pub mod HGE_rawshader_3Dsimple_frag
{
	vulkano_shaders::shader! {
		ty: "fragment",
		path: "./shaders_glsl/simple3D/frag.glsl"
	}
}
...
pub fn loadShaders()
{
	...
	Manager::ManagerShaders::singleton().add(
		...
		ShaderContent {
			shader: shaders,
			pushConstant_Func: Arc::new(|cmdBuilder, pipeline_layout, offset| {
				HTraceError!(cmdBuilder.push_constants(
					pipeline_layout,
					offset,
