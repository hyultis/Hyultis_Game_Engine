...
pub struct TextureDescriptor
{
	...
	_cacheVulkan: ArcSwap<PersistentDescriptorSet>
}
...
impl TextureDescriptor
{
	...
	pub fn getDescriptor(&self) -> Guard<Arc<PersistentDescriptorSet>>
	{
	...
	pub fn update(&self)
	{
		...
		self._cacheVulkan.swap(PersistentDescriptorSet::new(
