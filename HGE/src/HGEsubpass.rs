...
impl HGEsubpass
{
	...
	{
		return SINGLETON.get_or_init(|| HGEsubpass::new());
	}

	pub fn ExecAllPass(
		&self,
		render_pass: Arc<RenderPass>,
		mut primaryCommandBuffer: &mut AutoCommandBufferBuilder<PrimaryAutoCommandBuffer>,
		HGEFrameC: &HGEFrame,
		stdAllocCommand: Arc<StandardCommandBufferAllocator>,
	)
	{
